...
Fantasia: Urus Logistics`;
            ...
            navigator.clipboard.writeText(template)
                .then(() => {
                    ...
                    const excelStr = `${dataObj['Chamado NF (Solicitação)'] || 'INC'}\t${dataObj['Worker (Full Name)'] || ''}\t${dataObj['Enterprise ID'] || ''}\t${dataObj['ID'] || 'Sem ID'}\t${dataObj['PC Configuration Location'] || ''}\t${dataStr}\t${dataObj['Tenet'] || ''}`;
